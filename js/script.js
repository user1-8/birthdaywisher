...
const letsgo = () => {
  ...
  document.querySelector('.whatsapp_share').setAttribute('href', 'whatsapp://send?text=Hi%20*'+document.querySelector('.receivername').value+'*%20😄,%0A%0AI%20have%20someting%20*very%20special%20for%20you*.%20😜%0A%20A%20special%20message%20is%20also%20there%20😏%20*written%20by%20me*.%20%0ACheck%20it%20out%20below%20😁😁%0A%0A👇👇👇%0A'+ encodeURIComponent("https://user1-8.github.io/birthdaywisher/wish.html?"+"m="+document.querySelector('.msg').value+'&adm;'+"zpw=9f12aab23cd9ffd22b209bc90da2d"+'&adm;'+"d=2021-"+document.getElementById('monthselector').value+"-"+document.getElementById('dateselector').value+'&adm;'+"rn="+document.querySelector('.receivername').value+'&adm;'+"cn="+document.querySelector('.creatorname').value));
